...
# # ax.yaxis.grid(which='major', alpha=0.5)
#
# plt.ylabel('Latency (in milli.sec.)', fontsize=15)
# plt.xlabel('STATS-APP (1000x)', fontsize=15)

#setting horizontal and vertical lines for grid
for i in np.arange(0.1,max_lat_val,10):
    print i
    plt.hlines(i,0,25,colors='0.70')

for i in np.arange(0.1, max_lat_val, 50):
    print i
...
plt.xlabel('STATS (1000x)', fontsize=22)


# Save the figure
# fig.savefig(outDirForBoxplot+"TEST-FullBoxPlot-Latency-STATS"+ expID +".png", bbox_inches='tight')

fig.savefig("/Users/anshushukla/Downloads/Incomplete/pubs/vldbw-tpctc-2016/latex/plots/apps/app-latency-boxplot-STATS.pdf", bbox_inches='tight')
