...
legend((hB, hR), ('CPU', 'Memory'),loc='upper center', bbox_to_anchor=(0.5, 1.17),
          ncol=3, fancybox=True, shadow=True,fontsize=22)

hB.set_visible(False)
hR.set_visible(False)

plt.ylabel('CPU/Mem %',fontsize=24)
plt.xlabel('Virtual Machine ID',fontsize=24)
...
# savefig(outDirForBoxplot+'BoxPlotCPU-MEM-PREDICT-SYS.pdf', bbox_inches='tight')

savefig("/Users/anshushukla/Downloads/Incomplete/pubs/vldbw-tpctc-2016/latex/plots/apps/app-PRED-sys-cpu-mem.pdf", bbox_inches='tight')
