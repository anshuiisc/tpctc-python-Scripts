...
/usr/local/bin/sshpass -p dream@119  scp -o "ProxyCommand /usr/local/bin/corkscrew proxy.iisc.ernet.in 3128  $i 22"  anshu@$i:/home/anshu/toplogFinalSC/toplogBlobUpload/cpuIoTStatsTopologyTAXI-$expNum*  $path_dest
