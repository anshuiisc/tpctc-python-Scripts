...
# savefig(outDirForBoxplot+'BoxPlotCPU-MEM-PREDICT-TAXI.pdf', bbox_inches='tight')

savefig("/Users/anshushukla/Downloads/Incomplete/pubs/vldbw-tpctc-2016/latex/plots/apps/app-PRED-taxi-cpu-mem.pdf", bbox_inches='tight')
